...
PharmacyPage::PharmacyPage(DatabaseManager* db, QWidget* parent)
    ...
    auto* heading = new QLabel("Pharmacy / Medication Systems", this);
    heading->setStyleSheet("font-size: 20px; font-weight: 700;");
    root->addWidget(heading);

    auto* subtitle = new QLabel("Track pharmacy follow-up, medication delivery issues, prior authorizations, controlled-drug discrepancies, and med-cart process risks.", this);
    ...
    auto refreshTable = [db, tableWidget, cols]() {
        ...
        const auto rows = db->fetchTable("pharmacy_items", cols);
    ...
    itemName->setPlaceholderText("Pharmacy / med-system item");
    ...
    auto* button = new QPushButton("Add Pharmacy Item", this);
    ...
    QObject::connect(button, &QPushButton::clicked, this, [=]() {
        ...
        db->addRecord("pharmacy_items", values);
        refreshTable();
        dateEdit->clear();
        residentName->clear();
        itemName->clear();
