...
MdsTripleCheckPage::MdsTripleCheckPage(DatabaseManager* db, QWidget* parent)
    ...
    auto* heading = new QLabel("MDS / ARD / Triple Check", this);
    heading->setStyleSheet("font-size: 20px; font-weight: 700;");
    root->addWidget(heading);

    auto* subtitle = new QLabel(
        "Track MDS due dates, ARD targets, triple-check readiness, and the diagnosis detail imported from referrals and admissions.",
        this);
    ...
    const QStringList mdsCols{
        "resident_name", "payer", "assessment_type", "ard_date", "triple_check_date", "status", "owner", "notes"
    };
