...
AppWindow::AppWindow(DatabaseManager* db, const QString& fullName, const QString& roleName, QWidget* parent) : QMainWindow(parent) {
    setWindowTitle("LTC Administrator Operations Dashboard v62 Streamlined Operations");
    resize(1500, 940);
    ...
    auto* subtitle = new QLabel(
        "v62 removes Workflow Center, Backup & Restore, Census Management, and the standalone Outbreak tab, while keeping that functionality grouped under the remaining operational tabs.",
        header);
...
if (roleName == "Administrator") {
    ...
    allowed = {"Dashboard","Dashboard Setup","Alerts","Calendar","Residents","Admissions","Staffing","Tasks","Huddle","Social Services","Environmental Services","Medical Records","MDS","QAPI","Incidents","Survey Ready","Quality","Transportation","Dietary","Document Center","Reports"};
} else if (roleName == "Admissions Director") {
    allowed = {"Dashboard","Dashboard Setup","Alerts","Calendar","Residents","Admissions","Tasks","Huddle","Social Services","Environmental Services","Medical Records","MDS","Transportation","Document Center","Reports"};
} else if (roleName == "Staffing Coordinator") {
    allowed = {"Dashboard","Dashboard Setup","Alerts","Calendar","Staffing","Tasks","Huddle","Environmental Services","Reports"};
} else {
    allowed = {"Dashboard","Dashboard Setup","Alerts","Calendar","Residents","Admissions","Staffing","Tasks","Huddle","Social Services","Environmental Services","Medical Records","MDS","Quality","Document Center","Reports"};
}
